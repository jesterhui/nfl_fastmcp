...
This module contains all MCP tool definitions and the register_tools function
that centralizes tool registration with the FastMCP server.

Tool wrapper functions use the @mcp.tool() decorator and delegate to
implementation functions in their respective modules.
"""
...
def register_tools(mcp: FastMCP) -> None:
    ...
    This function centralizes tool registration, keeping server.py focused
    on app initialization and CLI handling.
